          ...
          <div class="p-6">
            ...
            >
              <div class="w-16 h-16 mx-auto mb-4 bg-lime-50 rounded-2xl flex items-center justify-center">
                <svg class="w-8 h-8 text-lime-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
            ...
            <div v-if="selectedFile" class="mt-4 bg-gray-50 rounded-xl p-4 flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                ...
                <button @click="upload" :disabled="uploading"
                  class="px-4 py-2 bg-lime-500 text-white text-sm font-medium rounded-xl hover:bg-lime-600 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center gap-2">
      ...
      <div class="space-y-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <template v-else-if="status.exists">
            <div class="space-y-4">
              <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-lime-50 rounded-xl flex items-center justify-center">
                  <svg class="w-5 h-5 text-lime-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                </div>
                <div>
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-1.5">
                  <span v-for="p in status.projects" :key="p"
                    class="bg-lime-50 text-lime-700 text-[11px] font-medium px-2.5 py-1 rounded-lg">
                    {{ p }}
                  </span>
                </div>
              </div>
