  ...
  <div>
    ...
    <template v-if="data">
      ...
      >
        ...
        <template #footnote>
          <FootnoteSource label="מקור:" text="נתוני P&L מערכת Logfi" :updated="updatedLabel" />
        </template>
      </RuledSection>
...
import { SectionHeader, RuledSection, HeroNumber, DataTable, FootnoteSource, currentHebrewDate } from './editorial'
